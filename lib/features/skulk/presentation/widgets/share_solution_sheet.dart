...
class ShareSolutionSheet extends StatelessWidget {
  final String solutionId;
  final String solutionBody;

  const ShareSolutionSheet({
    super.key,
    required this.solutionId,
    required this.solutionBody,
  });

  static void show(BuildContext context, String solutionId, String solutionBody) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) =>
          ShareSolutionSheet(solutionId: solutionId, solutionBody: solutionBody),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final shareUrl =
        'https://lostrunes.github.io/focusfox-share/share.html?solution_id=$solutionId';
